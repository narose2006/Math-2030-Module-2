...
\textit{Example 2: Consider a sphere with volune charge density $\rho=\frac{q}{V}$, and radius R. Find the magnitude of the electric field.}
\begin{figure}[!ht]
    \centering
...
\\ Case 1: $r<R$. Then $q=\rho(\frac{4}{3}\pi r^3)$. So: $$\Phi_E=\int E\cdot\mathrm{dA}=EA=\frac{q_{encl}}{\epsilon_0}$$.
$$E(4\pi r^2)=\frac{4\pi r^3\rho}{3\epsilon_0}\longrightarrow E=\frac{\rho r}{3\epsilon_0}$$
\\ Case 2: $r>R$. Then $q=\rho(\frac{4}{3}\pi R^3)$, and: $$\Phi_E=EA=\frac{\rho(\frac{4}{3}\pi R^3)}{\epsilon_0}$$. $$E(4\pi r^2)=\frac{\rho(\frac{4}{3}\pi R^3)}{\epsilon_0}\longrightarrow E=\frac{\rho R^3}{3\epsilon_0 r^2}$$
